...
export function QaPage() {
  ...
  return <article className="qa-page">
    ...
    {conversationOpen ? <QaDrawer title="选择对话" className="qa-overlay__panel--conversations" returnFocusTo={conversationTrigger} onClose={() => setConversationOpen(false)}><ConversationList items={items} selectedId={selectedId} onSelect={selectConversation} onNew={() => { setConversationOpen(false); setCreateOpen(true); }} onDeleteSelected={selectedId ? () => { setConversationOpen(false); setDeleteOpen(true); } : undefined} /></QaDrawer> : null}
