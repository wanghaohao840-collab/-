...
- Task 5: ready for independent re-review (implementation `9571ee9`; correction `2a6ea75`; focused GREEN `34 passed`; final frontend `99 passed`; typecheck/lint/build, component map `6/6`, token and diff checks PASS)
- Task 6: pending
