...
- Task 5: ready for independent review (implementation `9571ee9`; focused GREEN `25 passed`; final frontend `90 passed`; typecheck/lint/build, component map `6/6`, token and diff checks PASS)
- Task 6: pending
