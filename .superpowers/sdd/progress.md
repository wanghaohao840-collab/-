...
- Task 5a: in progress (Penpot empty-state visual correction discovered by Task 6)
- Task 6: waiting on Task 5a; functional `6/6` and document accessibility `6/6` already pass across three projects
