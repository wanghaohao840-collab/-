...
- Task 5: ready for independent re-review (implementation `9571ee9`; corrections `2a6ea75`, `aed0d5f`, `3b22198`; focused GREEN `36 passed`; final frontend `101 passed`; typecheck/lint/build, component map `6/6`, token and diff checks PASS)
- Task 6: pending
