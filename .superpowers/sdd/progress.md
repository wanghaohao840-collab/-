...
- Task 3: ready for independent re-review (latest fix `17b420d`; post-commit ambiguity closed; focused RED `3 failed, 1 passed`; focused GREEN `4 passed`; full GREEN `164 passed`)
- Task 4: pending
- Task 5: pending
- Task 6: pending
